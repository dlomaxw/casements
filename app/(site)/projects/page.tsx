    ...
    <>
      <section className="bg-brand-950 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-accent-400">Projects</p>
          <h1 className="mt-3 font-display text-4xl font-extrabold text-white sm:text-5xl">Our Work</h1>
          <p className="mt-5 max-w-2xl text-lg text-brand-100">
            From landmark commercial towers to private residences, our installations are built to last
      ...
      <section className="bg-steel-50 py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          {projects.map((p) => (
            <article key={p.name} className="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-brand-100">
